          ...
          <TouchableWithoutFeedback>
            <View style={styles.capsule}>
              ...
              <View style={styles.directiveSection}>
                <Text style={styles.directiveTitle}>CONFIRM DELETION</Text>
              ...
              <View style={styles.articleCard}>
                <View style={[styles.typeBadge, article.type === 'alert' && styles.typeBadgeAlert]}>
                  <Text style={styles.typeText}>{article.type === 'alert' ? 'URGENT ALERT' : 'GENERAL NEWS'}</Text>
                </View>
              ...
              <View style={styles.warningBox}>
                ...
                <Text style={styles.warningText}>
                  This action cannot be undone. The article will be removed from all member feeds.
                </Text>
              </View>
              ...
              <View style={styles.actionStack}>
                ...
                >
                  {loading ? (
                    ...
                    <>
                      ...
                      <Text style={styles.deleteBtnText}>Delete Article</Text>
                    </>
                  )}
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                >
                  <Text style={styles.cancelBtnText}>Keep Article</Text>
                </TouchableOpacity>
              </View>
            </View>
          </TouchableWithoutFeedback>
